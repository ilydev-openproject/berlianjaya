    ...
    <div class="col-4">
        <div class="card">
            ...
            <div class="card-body py-5">
                <form action="<?= site_url('admin/kelas/add_process') ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group mb-3">
                        <input type="text" class="form-control" name="nama_kelas" required placeholder="Masukkan Nama Kelas">
                    </div>
                    <div class="form-group mb-3">
                        <input type="number" class="form-control" name="jumlah_seat" required placeholder="Masukkan Jumlah Seat">
                    </div>
                    <div class="form-group mb-3">
                        <textarea name="fasilitas" class="summernote" id="summernote" cols="30" rows="300"></textarea>
                    </div>
                    <!-- <div class="form-group mb-3">
