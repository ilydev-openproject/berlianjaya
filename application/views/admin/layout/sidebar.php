...
<div class="leftside-menu">
    ...
    <a href="<?= site_url('admin/dashboard') ?>" class="logo logo-light">
        <span class="logo-lg">
            <img src="<?= base_url('/public/assets/img/logo/brand.png') ?>" class="w-100 h-100" alt="logo">
        </span>
        <span class="logo-sm">
            <img src="<?= base_url('/public/assets/img/favicon.png') ?>" alt="small logo">
        </span>
    </a>
    ...
    <a href="<?= site_url('admin/dashboard') ?>" class="logo logo-dark">
        <span class="logo-lg">
            <img src="<?= base_url('/public/assets/img/logo/brand.png') ?>" alt="dark logo">
        </span>
        <span class="logo-sm">
            <img src="<?= base_url('/public/assets/img/logo/brand.png') ?>" alt="small logo">
        </span>
    </a>
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="user">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="<?= site_url('admin/users') ?>">Data User</a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/users/add') ?>">Tambah User</a>
                        </li>
                    </ul>
                </div>
            </li>
            <!-- role -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#role" aria-expanded="false" aria-controls="role" class="side-nav-link">
                    <i class="mdi mdi-key-alert-outline"></i>
                    <span> Role </span>
                    <span class="menu-arrow"></span>
                </a>
                <div class="collapse" id="role">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="<?= site_url('admin/role') ?>">Data role</a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/role/add') ?>">Tambah Role</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <!-- kelas bus -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#kelas" aria-expanded="false" aria-controls="kelas" class="side-nav-link">
                ...
                <div class="collapse" id="kelas">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="<?= site_url('admin/kelas') ?>">Data Kelas Bus</a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/kelas/add') ?>">Tambah Kelas</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <!-- agen bus -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#agen" aria-expanded="false" aria-controls="agen" class="side-nav-link">
                ...
                <div class="collapse" id="agen">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="<?= site_url('admin/agen') ?>">Data Agen Bus</a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/agen/add') ?>">Tambah Agen</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <!-- pos bus -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#pos" aria-expanded="false" aria-controls="pos" class="side-nav-link">
                ...
                <div class="collapse" id="pos">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="<?= site_url('admin/pos') ?>">Data Pos Bus</a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/pos/add') ?>">Tambah Pos</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <!-- rute bus -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#rute" aria-expanded="false" aria-controls="rute" class="side-nav-link">
                ...
                <div class="collapse" id="rute">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="<?= site_url('admin/rute') ?>">Data Rute Bus</a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/rute/add') ?>">Tambah Pos</a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/rute/data_kota') ?>">Data Kota</a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/rute/add_kota') ?>">Tambah Kota</a>
                        </li>
                    </ul>
                </div>
            </li>
