...
<body class="authentication-bg position-relative">
                    ...
                    <div class="card overflow-hidden">
                        <div class="row g-0">
                            <div class="col-lg-6 d-none d-lg-block p-2">
                                <img src="<?= base_url('/public/Admin/dist/') ?>assets/images/auth-img.jpg" alt="" class="img-fluid rounded h-100">
                            </div>
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <div class="auth-brand p-4">
                                        <a href="index.html" class="logo-light">
                                            <img src="<?= base_url('/public/assets/img/logo/brand.png') ?>" alt="logo" height="62">
                                        </a>
                                        <a href="index.html" class="logo-dark">
                                            <img src="<?= base_url('/public/assets/img/logo/brand.png') ?>" alt="dark logo" height="62">
                                        </a>
                                    </div>
                                    <div class="px-4">
                                        <?php
                                        // Ambil nilai Flashdata
                                        $pesan = $this->session->flashdata('error');

                                        // Periksa apakah Flashdata tersedia sebelum menampilkannya
                                        if (!empty($pesan)) {
                                            echo '
                                                <div class="alert alert-pink alert-dismissible fade show" role="alert">
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                                <strong>Terjadi kesalahan - </strong>' . $pesan .
                                                '</div>';
                                        }
                                        ?>
                                    </div>
                                    <div class="p-4 my-auto">
                                        ...
                                        <p class="text-muted mb-3">
                                            Masukkan data username dan password yang sesuai dengan database
                                        </p>
                                        ...
                                        <form action="<?= site_url('auth/login_process') ?>" method="post">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="username" type="text" id="emailaddress" required="" placeholder="Masukkan Username">
                                            </div>
                                            <div class="mb-3">
    ...
    <footer class="footer footer-alt fw-medium">
        <span class="text-dark">
            ...
            </script> © PO. Berlian Jaya - Agcenna Digital Web Team
        </span>
    </footer>
    <!-- Vendor js -->
