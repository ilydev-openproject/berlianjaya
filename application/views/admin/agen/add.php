    ...
    <div class="col-4">
        <div class="card">
            ...
            <div class="card-body py-5">
                <form action="<?= site_url('admin/agen/add_process') ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group mb-3">
                        <input type="text" class="form-control" name="nama_agen" required placeholder="Masukkan Nama">
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <input type="text" class="form-control" name="titik" required placeholder="Masukkan detail lokasi">
                    </div>
                    <div class="form-group mb-3">
                        <input type="wa" class="form-control" name="wa" required placeholder="Masukkan nomor whatsapp +62">
                    </div>
                    <div class="form-group mb-3">
