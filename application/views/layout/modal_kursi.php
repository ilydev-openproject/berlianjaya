                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-10">
                                        <div class="form-group">
                                            ...
                                            <div class="button-group d-flex justify-content-start align-items-center">
                                                ...
                                                <select class="my-select" name="kelas" style="overflow: visible !important;" data-live-search="true" id="selectKelas<?= $agen['id_agen'] ?>" required>
                                ...
                                <!-- <input id="resultText<?= $agen['id_agen'] ?>" readonly> -->
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        sendMessageButton.addEventListener('click', function(event) {
                                            var selectKelas = document.getElementById('selectKelas<?= $agen['id_agen'] ?>');
                                            var selectedKelasValue = document.getElementById('selectedKelasValue<?= $agen['id_agen'] ?>');
                                            var selectedKelasText = selectKelas.options[selectKelas.selectedIndex].text;

                                            // Menambahkan event listener untuk mendengarkan perubahan nilai pada select
                                            selectKelas.addEventListener('change', function() {
                                                // Mendapatkan nilai kelas bus yang dipilih
                                                var selectedKelasText = selectKelas.options[selectKelas.selectedIndex].text;
                                                var selectedKelasId = selectKelas.options[selectKelas.selectedIndex].value;

                                                // Menampilkan kelas bus yang dipilih di console log
                                                console.log("Kelas bus yang dipilih:", selectedKelasText);

                                                // Menyimpan nilai kelas yang dipilih ke dalam elemen input
                                                selectedKelasValue.value = selectedKelasId;
                                            });
                                            selectedKelas = selectedKelasText;
                                            ...
                                            if (selectedKelas.value === "" || selectedKelas === "Pilih Kelas Bus") {
